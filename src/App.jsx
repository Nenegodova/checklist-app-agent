...
const DATA = {
  ...
  "Текст": [
    ...
    { text: "Поправить типографирование: м2, а не м2, 1/3, а не ⅓" },
  ...
  "Прочее": [
    ...
    { text: "В ссылке шаблона гугл-дока для копирования  /edit заменен на /copy." }, { text: "В ссылке шаблона гугл-дока для копирования  /edit заменен на /copy." },
