...
const PRESETS = {
  ...
  ugc3: {
    ...
    Текст: [
       ...
       {
        _sortOrder: 12,
        text: "В конце добавлен стандартный для формата опрос (можно взять из любого выпущеного материала)",
      },
      {_sortOrder: 0,
      text: "Проверить наличие плашки Сообщества",
      links: [
 ...
 {_sortOrder: 0,
  ...
  ugc8: {
    Админка: [
      ...
      { _sortOrder: 5, text: "Если в затравке отсутствует знак вопроса, то стоит двоеточие, затравка от лица автора" },
      {
        _sortOrder: 3,
